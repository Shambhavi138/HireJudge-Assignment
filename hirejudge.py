...
class CandidateEvaluator:
    ...
    def setup_prompt_template(self):
        """Setup LangChain prompt template as per requirements"""
...
Be concise and professional."""
    ...
    def evaluate_candidate(self, candidate_data: Dict[str, Any], target_role: str) -> str:
        """Evaluate candidate using free LangChain + Hugging Face"""
...
def main():
    ...
    with col1:
        ...
        # Evaluate button
        evaluate_btn = st.button("Evaluate with Free LangChain", type="primary")
    ...
    with col2:
        ...
        if evaluate_btn:
            if not json_input.strip():
                ...
                with st.spinner("🤖 LangChain + Hugging Face processing..."):
